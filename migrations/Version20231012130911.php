 ...
 */
final class Version20231012130911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (id INT NOT NULL, description_operation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
